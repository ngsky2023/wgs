...
sub processArgument {
	...
	my $path = "/share/public/database/Annovar/2017Jul16";
...
sub geneOperation {
	...
	#generate gene anno
	my $sc;
	#set hgvs and exonicsplicing as default
	$sc = "annotate_variation.pl -geneanno -buildver $buildver -dbtype $protocol -outfile $tempfile.$protocol --hgvs --exonicsplicing --splicing_threshold 2 -exonsort $queryfile $dbloc";
