...
my $ver="1.0";
my %opts;
GetOptions(\%opts,"s=s","o=s","log=s","h");

if(!defined($opts{o}) || !defined($opts{s}) || !defined($opts{log})|| defined($opts{h}))
{
	print <<"	Usage End.";
...
my $main_NM = "/share/work2/yangrutao/workdir/research/databases/variant_summary.GRCh37.gene_MainNM_ClinVar20171031.txt";
